...
if ($method == "POST") {
    ...
    if (isset($_GET["done"])) {
        $result = $uploader->combineChunks("../../SubidArchivos/archivos/archivosUsuario");
    }
    // Handles upload requests
    else {
        // Call handleUpload() with the name of the folder, relative to PHP's getcwd()
        $result = $uploader->handleUpload("../../SubidArchivos/archivos/archivosUsuario");
...
// for delete file requests
    ...
    $result = $uploader->handleDelete("../../SubidArchivos/archivos/archivosUsuario");
    echo json_encode($result);
}
else {
